...
본 연구에서는 영국 런던을 대상으로 에어비앤비 슈퍼호스트 여부에 영향을 미치는 조건들을 분석하고자 한다. 런던은 전 세계적으로 인기 있는 여행지로, 다양한 문화적 배경과 다양한 숙박 옵션이 공존하는 도시이다. 따라서 런던의 에어비앤비 데이터를 분석하는 것은 슈퍼호스트 여부에 영향을 미치는 조건들을 파악하는 데 있어 매우 유용하다. 이를 통해 런던 지역에서 슈퍼호스트가 되기 위해 중요한 요소들이 무엇인지 밝히고자 한다.
## 1.2 연구 목적
